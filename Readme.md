...
🌊 [**FloodGuard**](https://github.com/HaleyyT/FloodGuard) ([Demo](https://floodguard-project.vercel.app/)): Flood-awareness project using API integration, data ingestion of local weather, rainfall, river-context signals, ML, risk-scoring logic and map-based visualisation. Won Best UG senior project 2nd Prize at [Coding Fest 2026](https://www.sydney.edu.au/engineering/industry-community/partner-with-us/coding-fest.html)
